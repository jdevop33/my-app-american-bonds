  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
      ...
      <div className="prose max-w-none mb-12">
        ...
        <p>
          The City of Edinburgh Council embarked on an ambitious project to
          upgrade approximately 64,000 streetlights to smart LED systems. This
          large-scale initiative aimed to significantly reduce energy
          consumption and associated costs while improving lighting quality
        ...
        <p>
          A survey conducted during the pilot phase revealed overwhelming public
          support for the new LED lighting:
        </p>
        <ul>
        ...
        <p>
          The city has been proactive in addressing concerns about brightness
          and color temperature through careful design and community engagement.
        </p>
        ...
        <ul>
          ...
          <li>
            Reduced maintenance costs due to longer lifespan of LED lights
          </li>
        </ul>
        <p>
          These savings allow Edinburgh to reinvest in other critical
          infrastructure and services, benefiting residents across the city.
        </p>
        ...
        <p>
          Edinburgh&apos;s project is part of a larger trend across the UK. The
          Scottish Futures Trust reported that a £298 million investment in LED
          street lighting across Scotland could generate potential savings of
          approximately £1.3 billion over a 20-year period. This highlights the
          immense potential for other cities to achieve similar results.
        </p>
      </div>
