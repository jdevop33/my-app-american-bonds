  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
      ...
      <p className="text-xl text-muted-foreground mb-12 max-w-3xl">
        Discover a low-risk, high-impact investment opportunity that aligns with ESG goals and opens access to a broader
        pool of investors.
      </p>
      ...
      <div className="bg-muted rounded-lg p-8 mb-12">
        <h2 className="text-2xl font-serif font-bold text-foreground mb-4">Case Study: Calgary's $5M Annual Savings</h2>
        <p className="text-muted-foreground mb-4">
          Calgary's implementation of LED streetlight upgrades, financed through a model similar to Bright America
          Bonds, resulted in $5 million annual savings. This case study demonstrates the potential for significant
          returns and positive environmental impact.
        </p>
        <Link href="/case-studies/calgary" className="text-primary font-semibold hover:underline">
          Read Full Case Study →
        </Link>
      </div>

      <div className="text-center">
        <h2 className="text-3xl font-serif font-bold text-foreground mb-6">Ready to Invest in America's Future?</h2>
