    ...
    <div className="bg-white">
        ...
        <div className="relative container mx-auto px-4 py-24 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-6 text-xl">
              Smart financing for sustainable cities. Upgrade infrastructure without upfront costs.
            </p>
      ...
      <section id="learn-more" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">Infrastructure That Pays for Itself</h2>
            <p className="mt-4 text-lg text-gray-600">
              Bright America Bonds provide municipalities with the capital to upgrade critical infrastructure—starting
              with energy-efficient street lighting—without upfront costs. These bonds are repaid through guaranteed
              energy savings, creating a win-win situation for cities, investors, and local communities.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <BenefitCard
              ...
              benefits={["Low-Risk Investment", "High Demand", "ESG and Green Investment Alignment"]}
            />
            <BenefitCard
              icon={<Building className="w-12 h-12 text-pictonBlue-600" />}
              title="For Municipal Leaders"
              benefits={["No New Taxes or Budget Increases", "Immediate Modernization", "Community Impact"]}
            />
            <BenefitCard
              icon={<Users className="w-12 h-12 text-pictonBlue-600" />}
              title="For Residents and Advocates"
              benefits={["Brighter, Safer Streets", "Sustainable and Efficient", "Job Creation"]}
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">The Economic Impact</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold mb-4">$1M Investment Example</h3>
              <p className="text-gray-600">
                A $1 million bond can upgrade an entire city's street lighting system, leading to $300,000 in annual
                savings.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600">
                Each project includes local workforce training and development, creating jobs and building a skilled
                labor pool.
              </p>
            </div>
          </div>
          <div className="mt-8 text-center">
            <p className="text-lg text-gray-700">
              "Bright America Bonds empower municipalities to take control of their infrastructure needs, align with
              sustainability goals, and drive local economic growth—all with minimal financial risk."
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-lg text-gray-700 mb-6">
              Bright America Bonds can help finance advanced pedestrian safety solutions, such as LED crosswalk control
              treatments. These systems not only enhance safety but also contribute to energy savings and smart city
              initiatives.
            </p>
            ...
            <p className="text-lg text-gray-700 mb-6">
              A study in British Columbia, Canada, provides insights into the costs and effectiveness of various
            ...
            <div className="mt-8 bg-pictonBlue-50 p-6 rounded-lg">
              <div className="flex items-start mb-4">
                ...
                <p className="text-gray-700">
                  After standard signs and markings, solar-powered RRFB systems were found to be the most cost-effective
                  to install and operate when compared to overhead beacons. These systems can significantly reduce both
              ...
              <div className="flex items-start">
                ...
                <p className="text-gray-700">
                  The study showed that driver compliance at crosswalks increased significantly after implementing smart
                  crosswalk systems. In-Road Warning Lights (IRWL) systems improved compliance by 25-45%, while
                  Rectangular Rapid Flashing Beacons (RRFBs) increased compliance by 14-34%.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Calculate Your Savings</h2>
          <SavingsCalculator />
        </div>
      </section>
      ...
      <section className="py-16 bg-pictonBlue-700 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to Brighten Your City's Future?</h2>
          <p className="text-xl mb-8">
            Learn how Bright America Bonds can transform your municipality or investment portfolio.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/contact?type=municipality" className="btn-pictonBlue-outline">
              For Municipalities
            </Link>
            <Link href="/contact?type=investor" className="btn-pictonBlue-outline">
              For Investors
            </Link>
          </div>
        </div>
...
const BenefitCard = ({ icon, title, benefits }: { icon: React.ReactNode; title: string; benefits: string[] }) => (
  <div className="bg-white p-6 rounded-lg shadow-lg">
