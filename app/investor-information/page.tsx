      ...
      <div className="container mx-auto px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg">
          ...
          <blockquote className="italic text-gray-700 mb-4">
            &quot;Municipal bonds represent one of the safest asset classes in the
            world, offering consistent returns and supporting vital
            infrastructure projects.&quot;
          </blockquote>
          <p className="text-right">— JP Morgan Asset Management</p>
          <blockquote className="italic text-gray-700 mb-4 mt-8">
            &quot;The savings generated by LED streetlights provide a reliable and
            predictable funding source for bond repayment.&quot;
          </blockquote>
