...
const treatments = [
  { treatment: "Sign and Markings", cost: "Less than $10,000", compliance: "Baseline" },
  { treatment: "Solar RRFB system", cost: "$35,000", compliance: "14% to 34% increase" },
  {
    treatment: "AC RRFB system",
    cost: "Line power location dependent + operation cost",
    compliance: "14% to 34% increase",
  },
  { treatment: "Solar IRWL + RRFB", cost: "$50,000", compliance: "25% to 45% increase" },
  {
  ...
  { treatment: "Pedestrian or half signal", cost: "$125,000 + operation cost", compliance: "Varies" },
]
      ...
      <table className="min-w-full bg-white border border-gray-300">
        <thead>
          <tr className="bg-pictonBlue-50">
            ...
            <th className="py-2 px-4 border-b text-left">Driver Compliance Improvement</th>
          </tr>
        </thead>
        <tbody>
