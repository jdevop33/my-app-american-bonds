  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg">
      ...
      <p className="text-gray-600 mb-4">
        Bright America Bonds offer a unique opportunity to invest in sustainable
        infrastructure with attractive returns and low risk.
      </p>
